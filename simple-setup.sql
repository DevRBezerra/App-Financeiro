...
-- 2. Criar tabela de usuários (simples)
...
-- 3. Criar tabela de contas (sem foreign key para users)
...
-- 4. Criar tabela de categorias (sem foreign key para users)
...
-- 5. Criar tabela de transações (sem foreign keys)
